...
#define PWM 6
//ADC CFG
//on PWM mode, this is the  Potentiometer input
//on Amper meter mode, this is the meter input
#define ADC_CH  A0
//Digital CFG
...
uint16_t pwmController() {
  uint16_t reading = analogRead(ADC_CH);
  analogWrite(PWM, reading/4);  
  uint16_t pwmState = ((float)reading/1023) * 100;
  return pwmState;
}
